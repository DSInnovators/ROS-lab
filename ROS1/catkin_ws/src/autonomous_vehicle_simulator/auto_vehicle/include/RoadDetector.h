#ifndef AV_ROAD_DETECTOR_H_
#define AV_ROAD_DETECTOR_H_
...
public:
    ...
    const std::string &getDirectionFromLines(const std::vector<std::vector<cv::Vec4i>> &left_right_lines, const cv::Mat &inputImage); // Get the decision from detected lines
};

#endif // AV_ROAD_DETECTOR_H_
